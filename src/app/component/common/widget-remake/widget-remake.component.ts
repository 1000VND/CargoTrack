...
@Component({
  selector: 'app-widget-remake',
  templateUrl: './widget-remake.component.html',
  styleUrls: ['./widget-remake.component.scss']
})
export class WidgetRemakeComponent implements OnInit {
